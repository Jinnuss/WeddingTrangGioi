    ...
    <>
      <div className="container text-center">
          ...
          button1 ? (
            <div className='qr'>
              <div className='content'>
                ...
                <div className="img w-[285px] sm:h-[320px]   overflow-hidden imgshadow">
                  <img src={cap1} alt="ảnh 1" className="object-cover " />
                </div>
              </div>
            </div>
          ) :
        ...
        <div>
          ...
          <div className="flex justify-center mt-[30px] mb-[30px] md:mb-[130px]">
            <div className="w-[44%] md:w-[285px] md:h-[320px] ml-[10px]" >
              <img src={cap2} alt="ảnh 1" className="object-cover img2" />
            </div>
            <div className="w-[50%] ">
              <div className="w-[42%] flex md:w-[150px] md:h-[320px] mr-[10px] ml-[10px] mb-[10px] sm:mb-[0px]" >
                <img src={cap8} alt="ảnh 1" className="object-cover img2 mr-[10px]" />
                <img src={cap18} alt="ảnh 1" className="object-cover img2" />
              </div>
              <div className="w-[42%] flex md:w-[150px] md:h-[320px] mr-[10px] ml-[10px]">
                <img src={cap9} alt="ảnh 1" className="object-cover img2  mr-[10px]" />
                <img src={cap19} alt="ảnh 1" className="object-cover img2" />
              </div>
            </div>
          </div>
          <div className="flex justify-center mt-[30px] mb-[30px] md:mb-[130px]">
            ...
            <div className="w-[50%] ">
              <div className="w-[42%] flex md:w-[150px] md:h-[320px] mr-[10px] ml-[10px] mb-[10px] sm:mb-[0px]" >
                <img src={cap24} alt="ảnh 1" className="object-cover img2 mr-[10px]" />
                <img src={cap7} alt="ảnh 1" className="object-cover img2" />
              </div>
              <div className="w-[42%] flex md:w-[150px] md:h-[320px] mr-[10px] ml-[10px]">
                <img src={cap25} alt="ảnh 1" className="object-cover img2  mr-[10px]" />
                <img src={cap26} alt="ảnh 1" className="object-cover img2" />
              </div>
            </div>
            <div className="w-[44%] md:w-[285px] md:h-[320px] ml-[10px]" >
              <img src={cap33} alt="ảnh 1" className="object-cover img2" />
            </div>
          </div>
        </div>
